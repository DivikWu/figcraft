...
interface SceneNodeMixin extends ExplicitVariableModesMixin {
   ...
   */
  setBoundVariable(field: VariableBindableNodeField | VariableBindableTextField, variableId: string | null): void;
  /**
   * Binds the provided `field` on this node to the given variable. Please see the [Working with Variables](https://developers.figma.com/docs/plugins/working-with-variables) guide for how to get and set variable bindings.
   *
   * If `null` is provided as the variable, the given `field` will be unbound from any variables.
 ...
 */
interface SectionNode extends ChildrenMixin, MinimalFillsMixin, OpaqueNodeMixin, DevStatusMixin, AspectRatioLockMixin {
  /**
...
export {
  ...
  ScatterBrushProperties,
  StretchBrushProperties,
  BrushStrokeProperties,
  DynamicStrokeProperties,
  GeometryMixin,
  ComplexStrokesMixin,
  ...
  TransformModifier,
  RepeatModifier,
  LinearRepeatModifier,
  RadialRepeatModifier,
};
