...
const FIELD_TO_SCOPE: Record<string, string> = {
  ...
  opacity: 'OPACITY',
  // Extended scopes — surpasses Vibma's coverage
  width: 'WIDTH_HEIGHT',
  height: 'WIDTH_HEIGHT',
...
/**
 * Fill can be specified in 5 formats (surpasses Vibma's multi-format support):
 * 1. hex string: "#FF0000"
 ...
 *
 * Supports 5 input formats (surpasses Vibma):
 ...
 * Surpasses Vibma's applyCornerRadius with variable binding on all 4 corners.
 */
