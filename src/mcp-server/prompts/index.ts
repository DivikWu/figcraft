...
2. Call get_mode to check mode and get designContext (includes libraryComponents if available)
...
10. Create using create_document (batch) for layout structure
...
11. If create_document cannot express certain details (e.g. asymmetric padding), follow up with patch_nodes immediately.

## Check
12. Self-Review against Layout rules — verify:
...
13. Run lint_fix_all to verify compliance and auto-fix remaining issues.`,
        },
      }],
    }),
  );
