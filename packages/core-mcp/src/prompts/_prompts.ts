...
8. For local components, call components(method: "list_properties") to discover available variants.
   For library components, get_mode's libraryComponents shows component sets with variantCount, propertyNames, and containingFrame.
   ...
   When search returns isSet=true, use componentSetKey + variantProperties; when isSet=false, use componentKey.
