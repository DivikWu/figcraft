...
8. Run lint_fix_all to auto-fix what's possible, then report remaining violations`,
  ...
  server.prompt(
    'text-replacement',
    'Guide: Bulk replace text content in a Figma design (localization, data filling, content updates).',
    () => ({
      messages: [{
        role: 'user' as const,
        content: {
          type: 'text' as const,
          text: `Help me replace text content across a Figma design. Follow this workflow:
