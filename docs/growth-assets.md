...
| 资产 | 当前规模 | 复利效应 | 增长方式 |
|------|---------|---------|---------|
| **Skills** | 28 个 | AI 做得更好 | 新增/优化 skill |
| **Lint 规则** | 40 条（58% autoFix） | 质量底线自动抬高 | 新增规则 + autoFix |
| **Opinion Engine** | 10 项推断 + 13 项纠错 | 用户配置越来越少 | 新增智能默认值 |
| **UI 模板** | 9 种 × 3 tone = 27 变体 | 创建速度越来越快 | 新增模板 |
| **MCP 工具** | 111 个（31 core + 80 optional） | AI 能做的事越来越多 | 新增工具 |
| **Harness 规则** | 18 条（6 数据型 + 12 代码型） | AI 犯错概率越来越低 | 新增规则（YAML 或 TypeScript） |
| **测试套件** | 70 文件 / 1142 测试 | 迭代信心越来越强 | 跟随功能新增 |
